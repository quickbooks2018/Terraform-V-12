...
resource "aws_iam_policy" "rabbitmq-policy" {
  name        = "rabbitmq-policy"
  description = "rabbitmq-policy for service discovery"
...
resource "aws_iam_role_policy_attachment" "rabbitmq-policy-for-ec2-role" {
  role       = aws_iam_role.ec2-role.name
  policy_arn = aws_iam_policy.rabbitmq-policy.arn
}
