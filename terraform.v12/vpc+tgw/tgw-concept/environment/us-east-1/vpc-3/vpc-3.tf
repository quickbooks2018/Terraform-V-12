...
module "vpc" {
  ...
  name                                = "vpc-3-us-east-1"
  stage                               = "dev"
  map_public_ip_on_launch             = "false"
  total-nat-gateway-required          = "1"
  create_database_subnet_group        = "false"
  vpc-cidr                            = "10.2.0.0/16"
  vpc-public-subnet-cidr              = ["10.2.1.0/24","10.2.2.0/24"]
  vpc-private-subnet-cidr             = ["10.2.4.0/24","10.2.5.0/24"]
  vpc-database_subnets-cidr           = ["10.2.7.0/24", "10.2.8.0/24"]
}
...
module "sg-tgw" {
  ...
  ingress-rule-4-cidrs       = ["10.1.0.0/16"]
  ingress-rule-4-description = "Allow Traffic From VPC2"
  ...
  ingress-rule-3-cidrs       = ["10.2.0.0/16"]
...
module "ec2-tgw" {
  ...
  namespace                     = "cloudgeeksca-tgw"
  stage                         = "dev"
  name                          = "ec2-vpc-3-us-east-1"
  key_name                      = "transit-gateway-vpc-3"
