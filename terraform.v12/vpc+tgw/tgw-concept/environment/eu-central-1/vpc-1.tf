...
module "vpc" {
  ...
  name                                = "vpc-1-eu-central-1"
  stage                               = "dev"
  map_public_ip_on_launch             = "false"
  total-nat-gateway-required          = "1"
  create_database_subnet_group        = "false"
  vpc-cidr                            = "10.130.0.0/16"
  vpc-public-subnet-cidr              = ["10.130.1.0/24","10.130.2.0/24"]
  vpc-private-subnet-cidr             = ["10.130.4.0/24","10.130.5.0/24"]
  vpc-database_subnets-cidr           = ["10.130.7.0/24", "10.130.8.0/24"]
}
...
module "sg-tgw" {
  ...
  ingress-rule-1-cidrs = ["10.128.0.0/16"]
  ingress-rule-1-description = "Allow Traffic From VPC2-eu-west-1"
  ...
  ingress-rule-4-description = "Allow Traffic From VPC3-us-east-1"
  ...
  ingress-rule-3-cidrs       = ["10.130.0.0/16"]
